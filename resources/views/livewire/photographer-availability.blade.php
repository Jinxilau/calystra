<div class="container-fluid py-4">
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="mb-0">{{ $isEditing ? 'Edit' : 'Add' }} Unavailable Period</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="small">
                                    <strong>Start:</strong> {{ $availability->start_date->format('M j, Y g:i A') }}<br>
                                    <strong>End:</strong> {{ $availability->end_date->format('M j, Y g:i A') }}
                                </div>
                            </td>
                            <td>
                                <span class="badge bg-info">
                                    {{ $availability->start_date->diffInDays($availability->end_date) + 1 }} day(s)
                                </span>
                            </td>
